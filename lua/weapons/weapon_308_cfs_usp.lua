...
SWEP.PA_Sound = "weapons/usp/g_shoot_usp_1.wav"
...
SWEP.DrawAnimRate=.15
SWEP.DrawSound = {{Delay=.1,Sound="weapons/usp/g_reload_usp.wav"}}
SWEP.ReloadAnim="vk.com/cf_source_reload"
SWEP.ReloadAnimRate=.25
SWEP.ReloadSound = {
{Sound="weapons/usp/g_mzc_usp_bback.wav"},
{Delay=.3,Sound="weapons/usp/g_mzc_usp_clipout.wav"},
{Delay=.4,Sound="weapons/usp/g_mzc_usp_clipin.wav"},
}
SWEP.ReloadSound2 = {
{Sound="weapons/usp/g_mzc_usp_bback.wav"},
{Delay=.3,Sound="weapons/usp/g_mzc_usp_clipout.wav"},
{Delay=.4,Sound="weapons/usp/g_mzc_usp_clipin.wav"},
{Delay=1.4,Sound="weapons/usp/g_mzc_usp_bcback.wav"},
}
SWEP.CenterAng = Angle(0,-90,0)
SWEP.CenterPos = Vector(1,-120,0)
...
function SWEP:ShootAnim()self:PlayAnim("vk.com/cf_source_prefire",.5)end