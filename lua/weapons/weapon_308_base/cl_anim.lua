...
local render_SetColorModulation = CLIENT and render.SetColorModulation
local render_SetBlend = CLIENT and render.SetBlend
local render_CullMode = CLIENT and render.CullMode
local render_EnableClipping = CLIENT and render.EnableClipping
local math_min = math.min
local render_PushCustomClipPlane = CLIENT and render.PushCustomClipPlane
local render_PopCustomClipPlane = CLIENT and render.PopCustomClipPlane
