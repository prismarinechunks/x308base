if !util.IsValidModel("models/fosterz/weapons/viewmodels/c_ak47.mdl")then return end
SWEP.Base = "weapon_308_base" -- Don't touch!if you true to do you better write a base
SWEP.PrintName = "CFS AK47"
SWEP.Category = "x308 Base | Guns"
SWEP.HoldType = "ar2"
SWEP.ViewModel = "models/fosterz/weapons/viewmodels/c_ak47.mdl"
...
SWEP.WElements = {
	["1"] = { type = "Model", model = "models/fosterz/weapons/worldmodels/w_ak47.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2.226, 0.662, -0.311), angle = Angle(180, -90, 10), size = Vector(1.1, 1.1, 1.1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
