...
function ENT:SpawnFunction(ply, tr)
	...
	local ent = ents.Create( "obj_308_md" )
	ent:SetPos(SpawnPos)
	ent:Spawn()
end
end
...
if p:Health()<1 then
if self.Timer<CurTime()then p:ChatPrint("LOLOLOLOLOLOLOLOLO.....")end
...
if self.Timer>CurTime()+50 then
GG(0,1)
GG(1,1.8,1)
self.Timer2=CurTime()+2.3
elseif self.Timer>CurTime()+36 then
GG(0,1.5)
GG(1,2.2)
GG(2,2.9,1)
self.Timer2=CurTime()+3.4
elseif self.Timer>CurTime()+23 then
GG(0,2.2)
GG(1,2.8)
GG(2,3.4)
GG(3,4,1)
self.Timer2=CurTime()+4.6
elseif self.Timer>CurTime()+11 then
GG(0,2.5)
GG(1,3.1)
GG(2,3.7)
GG(3,4.4)
