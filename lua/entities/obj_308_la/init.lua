...
for _,p in pairs(player.GetAll())do
p:PrintMessage(4,GAME308_LAN1["gtd"]..GAME308_LAN1["t"]..ti..GAME308_LAN1["t0"])
end
else
if self.Math>a then
for _,p in pairs(player.GetAll())do
if self.PPhase==0 then
p:PrintMessage(4,GAME308_LAN1["la"]..ti..GAME308_LAN1["rs"]..self.Math)
else
p:PrintMessage(4,GAME308_LAN1["la1"]..ti..GAME308_LAN1["rs"]..self.Math)
end
end
...
local w=ents.Create("weapon_308_r")
